// Hàm tăng số lượng sản phẩm khi người dùng chọn sản phẩm
var plusCart = () => {
    cartCount++;
...
var addFoodInCart = (nameFood, moneyFood) => {
    ...
    swal("Giỏ hàng Chicken DEV cho biết", `Bạn vừa thêm ${nameFood} có giá ${ formatCash(String(moneyFood))} VNĐ vào giỏ hàng (Nếu sản phẩm có khuyến mãi thì đã được trừ)`, "success");
